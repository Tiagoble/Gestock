...
public class FormLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.add(txtLogin, new org.netbeans.lib.awtextra.AbsoluteConstraints(102, 160, 320, 40));

        txtPassword.setBackground(new java.awt.Color(255, 255, 255));
        txtPassword.setFont(new java.awt.Font("Adwaita Sans", 0, 18)); // NOI18N
        txtPassword.setText("Password");
        txtPassword.setBorder(null);
        jPanel3.add(txtPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(102, 218, 320, 40));
